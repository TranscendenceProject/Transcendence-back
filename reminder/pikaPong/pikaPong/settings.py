"""
Django settings for pikaPong pikaPong.
...
# Build paths inside the pikaPong like this: BASE_DIR / 'subdir'.
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_REFRESH_LIFETIME': timedelta(days=1),  # 슬라이딩 갱신 토큰 유효 시간
    'SLIDING_TOKEN_LIFETIME': timedelta(days=1),  # 슬라이딩 토큰 유효 시간
